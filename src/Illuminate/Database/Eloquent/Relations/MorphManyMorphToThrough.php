...
class MorphManyMorphToThrough extends MorphManyBelongsToThrough
{
    /**
    ...
    public function __construct(Builder $query, Model $farParent, Model $throughParent, $firstType, $firstKey, $secondType, $secondKey, $localKey, $secondLocalKey)
    {
        ...
        $this->secondMorphClass = $query->getModel()->getMorphClass();
    ...
    {
        return $this->throughParent->getTable().'.'.$this->secondMorphType;
    }
}
